...
namespace common\components\xlstemplate;
...
//            if (mb_strlen($dataSource[0]) > 48) {
//                $worksheet->getRowDimension($row->getRowIndex())->setRowHeight(60);
//                $worksheet->getStyle("A" . $row->getRowIndex())->getAlignment()->setWrapText(true);
//            } elseif (mb_strlen($dataSource[0]) > 24) {
//                $worksheet->getRowDimension($row->getRowIndex())->setRowHeight(40);
//                $worksheet->getStyle("A" . $row->getRowIndex())->getAlignment()->setWrapText(true);
//            }
