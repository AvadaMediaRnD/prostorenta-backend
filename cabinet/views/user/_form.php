...
/* @var $modelForm cabinet\models\UserForm */
...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-6">
        <?= $form->field($modelForm, 'uid', ['enableClientValidation' => false])->textInput(['readonly' => true]) ?>
    </div>
</div>
<div class="row">
    <div class="col-xs-12 col-sm-6">
...
<div class="row">
    <div class="col-xs-12 text-right">
        <a href="<?= Yii::$app->urlManager->createUrl('/user/view') ?>" class="btn btn-default">Отменить</a>
