...
$this->title = Yii::t('app', 'Показания счетчиков');
if ($searchModel->flat_id && $searchModel->flat) {
    $this->title .= ', кв.' . $searchModel->flat->flat;
}
    ...
    <div class="col-xs-12">
        ...
        */ ?>
        ...
        <div class="pull-right margin-bottom">
            <a class="btn btn-success" href="<?= Yii::$app->urlManager->createUrl(['/counter-data/create', 'flat_id' => $searchModel->flat_id, 'service_id' => $searchModel->service_id]) ?>">Добавить показание</a>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header with-border">
                ...
                <div class="box-tools">
                    <a href="<?= Yii::$app->urlManager->createUrl(['/counter-data/counter-list', 'CounterDataSearch[flat_id]' => $searchModel->flat_id]) ?>" class="btn btn-default btn-sm">
            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'filter' => false,
//                        'filter' => \kartik\select2\Select2::widget([
//                            'data' => CounterData::getMonthYearOptions(),
//                            'model' => $searchModel,
//                            'attribute' => 'searchUidMonthYear',
//                            'theme' => \kartik\select2\Select2::THEME_DEFAULT,
//                            'options' => [
